...
<p align="center">
  <a href="https://github.com/orgs/open-traffic-generator/packages/container/package/ixia-c-controller"><img alt="Release v0.0.1-3662" src="https://img.shields.io/badge/release-v0.0.1--3662-brightgreen"></a>
  <a href="https://redocly.github.io/redoc/?url=https://raw.githubusercontent.com/open-traffic-generator/models/v0.9.10/artifacts/openapi.yaml"><img alt="Open Traffic Generator v0.9.10" src="https://img.shields.io/badge/open--traffic--generator-v0.9.10-brightgreen"></a>
  <a href="https://pypi.org/project/snappi/0.9.8"><img alt="snappi v0.9.8" src="https://img.shields.io/badge/snappi-v0.9.8-brightgreen"></a>
...
* Optionally, Generate Traffic Using [curl](https://curl.se/)
  ...
  >The detailed description of each node (and their attributes) in JSON configuration are well documented [here](https://redocly.github.io/redoc/?url=https://raw.githubusercontent.com/open-traffic-generator/models/v0.9.10/artifacts/openapi.yaml).
