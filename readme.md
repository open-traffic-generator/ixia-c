...
<p align="center">
  ...
  <a href="https://pypi.org/project/snappi/0.5.6"><img alt="snappi v0.5.6" src="https://img.shields.io/badge/snappi-v0.5.6-brightgreen"></a>
...
* Generate Traffic using [snappi](https://pypi.org/project/snappi/)
  ...
  # install snappi
  python -m pip install --upgrade snappi==0.5.6
