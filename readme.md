...
<p align="center">
  ...
  <a href="https://redocly.github.io/redoc/?url=https://raw.githubusercontent.com/open-traffic-generator/models/v0.11.1/artifacts/openapi.yaml"><img alt="Open Traffic Generator v0.11.1" src="https://img.shields.io/badge/open--traffic--generator-v0.11.1-brightgreen"></a>
...
* Optionally, Generate Traffic Using [curl](https://curl.se/)
  ...
  >The detailed description of each node (and their attributes) in JSON configuration are well documented [here](https://redocly.github.io/redoc/?url=https://raw.githubusercontent.com/open-traffic-generator/models/v0.11.1/artifacts/openapi.yaml).
