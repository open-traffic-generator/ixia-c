...
<p align="center">
  <a href="https://hub.docker.com/r/ixiacom/ixia-c-controller/tags"><img alt="Release v0.0.1-2934" src="https://img.shields.io/badge/release-v0.0.1--2934-brightgreen"></a>
  <a href="https://redocly.github.io/redoc/?url=https://github.com/open-traffic-generator/models/releases/download/v0.7.13/openapi.yaml"><img alt="Open Traffic Generator v0.7.13" src="https://img.shields.io/badge/open--traffic--generator-v0.7.13-brightgreen"></a>
  <a href="https://pypi.org/project/snappi/0.7.37"><img alt="snappi v0.7.37" src="https://img.shields.io/badge/snappi-v0.7.37-brightgreen"></a>
...
* Optionally, Generate Traffic Using [curl](https://curl.se/)
  ...
  >The detailed description of each node (and their attributes) in JSON configuration are well documented [here](https://redocly.github.io/redoc/?url=https://github.com/open-traffic-generator/models/releases/download/v0.7.13/openapi.yaml).
