...
3. (Optional) If cluster does not have access to ghcr.io, manually download container images and push them to all nodes in the cluster
    ...
    docker pull ghcr.io/open-traffic-generator/keng-controller:1.51.0-1
    docker pull ghcr.io/open-traffic-generator/ixia-c-traffic-engine:1.8.0.245
    docker pull ghcr.io/open-traffic-generator/ixia-c-protocol-engine:1.00.0.517
    ...
    kind load docker-image ghcr.io/open-traffic-generator/keng-controller:1.51.0-1
    kind load docker-image ghcr.io/open-traffic-generator/ixia-c-traffic-engine:1.8.0.245
    kind load docker-image ghcr.io/open-traffic-generator/ixia-c-protocol-engine:1.00.0.517
