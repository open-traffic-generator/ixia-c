...
# Release Features(s)
* <b><i>Ixia Chassis & Appliances(Novus, AresOne)</i></b>: Support added for DHCPv4 Client and Server. 
...
* <b><i>Ixia Chassis & Appliances(Novus, AresOne)</i></b>: gNMI support added to fetch DHCPv4 Client and Server statistics. 
  ...
  ```
    Note: Support for `GetStates` of DHCP Server will be given in subsequent release. 
