...
Ixia-c implements version **[v0.6.1](https://github.com/open-traffic-generator/models/releases/tag/v0.6.1)** of the Open Traffic Generator Data Model. You can view the model [here](https://redocly.github.io/redoc/?url=https://github.com/open-traffic-generator/models/releases/download/v0.6.1/openapi.yaml).
