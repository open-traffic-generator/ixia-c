...
Ixia-c implements version **[v0.11.1](https://github.com/open-traffic-generator/models/releases/tag/v0.11.1)** of the Open Traffic Generator Data Model. You can view the model [here](https://redocly.github.io/redoc/?url=https://raw.githubusercontent.com/open-traffic-generator/models/v0.11.1/artifacts/openapi.yaml).
